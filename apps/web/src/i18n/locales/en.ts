const en = {
  common: {
    appName: 'Amplify',
    appFullName: 'Amplify - Document Intelligence Platform (DIP)',
    save: 'Save',
    cancel: 'Cancel',
    delete: 'Delete',
    edit: 'Edit',
  ...
  timings: {
    ...
    comparisonAnalysis: 'Multi-document analysis',
  },
  tokens: {
    title: 'Token usage',
    total: 'Total',
  ...
  login: {
    title: 'Amplify - Document Intelligence Platform (DIP)',
    email: 'Email',
    password: 'Password',
    signIn: 'Sign In',
    devSignIn: 'Dev Login',
  ...
  analysis: {
    ...
    fieldTemplateHint:
      'Select a field template to define which fields to extract from the document.',
    ...
    runDisabledUpload: 'Upload a document and wait for text extraction to finish.',
    ...
    fieldExtraction: 'Field Extraction',
    riskAnalysis: 'Risk Analysis',
    originalContractDescription: 'Original Document Description',
    ...
    progress: {
      ...
      stillWorking: 'Still working — larger documents and higher reasoning effort take longer…',
  ...
  compare: {
    ...
    step1: '1. Upload Documents (2–5)',
    step2: '2. Select Comparison Prompt',
    step3: '3. Select Model & Run',
    step4: '4. AI Analysis Result',
    documents: 'Documents',
    documentNumber: 'Document {{number}}',
    uploadDocument: 'Click or drag a document here to upload',
    replaceDocument: 'Click or drag a file to replace this document',
    addDocument: 'Add Document',
    promptHint: 'Select a prompt template for multi-document analysis or comparison.',
    compare: 'Compare',
    compareDisabledDocuments: 'Upload every document and wait for text extraction to finish.',
    compareDisabledPrompt: 'Select a document comparison prompt template first.',
  ...
  settings: {
    ...
    comparisonPrompts: 'Document Comparison Prompts',
  ...
  templateEditor: {
    ...
    promptGuidance:
      'Write the analysis guidance only. The API adds the document text and returns Original Document Description and Risk Analysis as separate sections automatically.',
  ...
  admin: {
    ...
    users: {
      ...
      firstAdminNameRequired: 'First admin name is required',
      firstAdminEmailRequired: 'First admin email is required',
      ...
      updateOrganizationStatusFailed: 'Failed to update organization status',
    ...
    system: {
      ...
      apiKey: {
        intro:
          'A single shared API key for all administrators. Use it to call the document analysis and compare APIs externally via <1>X-API-Key</1> header.',

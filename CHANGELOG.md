...
* record & display run timings (OCR, field extraction, risk analysis) ([0c96386](https://github.com/shidafu666/amplify/commit/0c963864061b037b8c79466bab91346f0c3fbd67))
...
* **web:** always-visible scrollbars on analysis result panes ([2653fd0](https://github.com/shidafu666/amplify/commit/2653fd0d5a67676de1fd5308bc45c1eae8077a55))
...
* **web:** Amplify logo (chevron mark) + animated login background ([7b01a40](https://github.com/shidafu666/amplify/commit/7b01a40ba2bcf9f27d41bb811ee10b97841b6eb9))
...
* **web:** clickable compare history with diff detail drawer ([93a9f61](https://github.com/shidafu666/amplify/commit/93a9f61d39eede6d7e311618cfac97428125fd8a))
* **web:** full-screen Analysis Details with wrapping field table ([45d7763](https://github.com/shidafu666/amplify/commit/45d7763efe9c3add55d611ec97556eb6c7fc01a3))
...
* **web:** i18n (zh/en), dark mode, and mobile responsive UI ([ef1bdf6](https://github.com/shidafu666/amplify/commit/ef1bdf6d37e1b7bc488c124d5580e483b6b8b77b))
...
* **web:** persist compare page state across navigation ([eb6fefa](https://github.com/shidafu666/amplify/commit/eb6fefa7cf6707cf55d39cf1bcff440bb074654b))
...
* **web:** surface analysis result ID for feedback lookup ([44e2422](https://github.com/shidafu666/amplify/commit/44e2422ffc8cf3d5cf326ed57b429c1ebf9c379a))
...
* **web:** upload + OCR progress in contract comparison ([d23c915](https://github.com/shidafu666/amplify/commit/d23c915fced33a9bea7ed5f23d82fe03fb4110cf))


### Bug Fixes

* **api:** decode non-English upload filenames (UTF-8) ([06c5b52](https://github.com/shidafu666/amplify/commit/06c5b520577ef5400ac92a8424c19e49bbfc6f7e))
...
* **api:** let admins view other users' analysis detail in All History ([ec40ef4](https://github.com/shidafu666/amplify/commit/ec40ef4469c4e12698d154fbd50c7d84b3f37de6))
...
* **api:** switch Anthropic thinking to adaptive + output_config.effort ([c2cee89](https://github.com/shidafu666/amplify/commit/c2cee897acdc098b9220338059de42aa3084633e))
...
* **auth:** stop SSO redirecting to localhost in deployed environments ([ef479a5](https://github.com/shidafu666/amplify/commit/ef479a5fb794553fe0d915885b9097b3ff2fdb64))
...
* **lint:** resolve all ESLint errors and warnings across web app ([f3a07b8](https://github.com/shidafu666/amplify/commit/f3a07b8e499c31471121174d68da26251130bc88))
...
* **makefile:** drop git fsmonitor socket before az acr build ([c5f0806](https://github.com/shidafu666/amplify/commit/c5f0806d9a452ebd717691e5c7fe43317be80083))
...
* scope "My History" to current user; admin-only all-history endpoint ([b01b6e1](https://github.com/shidafu666/amplify/commit/b01b6e199162ffb5c0566fcbcbe7b8cb3b4853f4))
